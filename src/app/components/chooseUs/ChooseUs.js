    ...
    return (
        <main className='w-full h-screen flex-col px-[200px]  flex  items-center bg-white' >
            <div className='flex flex-col items-center w-[800px] mt-[100px] text-center gap-[10px]' >
                ...
                <h1 className='text-[18px] font-normal' >Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry standard </h1>
            </div>
